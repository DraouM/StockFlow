...
function setupConfirmButton(transactionId) {
  if (transactionId) {
    console.log("UPDATE A TRANSACTION");

    // Update an existing transaction
    confirmButton.textContent = "UPDATE TRANSACTION";
    // confirmButton.onclick = () => updateTransaction(transactionId);
  } else {
    console.log("CREATE A NEW TRANSACTION");

    // Create a new transaction
    confirmButton.textContent = "CONFIRM ORDER";
    // confirmButton.onclick = createTransaction;
  }
}

// Call this after determining the transaction context
setupConfirmButton(transactionId);

// function createTransaction() {
//   const formData = getTransactionData();
...
//   const formData = getTransactionData();
//   // Add logic to update the transaction with transactionId
//   console.log(`Updating transaction ${transactionId}:`, formData);
//   // Redirect or notify user on success
// }
...
//     // Create an instance of ShoppingListManager
...
//     await populateEditableShoppingList(shoppingListManager, transactionDetails);

//     // Set up event listeners for tracking changes
//     setupChangeTrackingListeners(shoppingListManager);
...
//     shoppingListManager.addProduct(productDetails);
//   }
...
// function setupChangeTrackingListeners(shoppingListManager) {
//   // Example: Track changes when confirm button is clicked
//   const confirmButton = document.getElementById("confirmTransactionBtn");
//   confirmButton.addEventListener("click", () => {
//     // Get change history
//     const changeLog = shoppingListManager.getChangeHistory();
